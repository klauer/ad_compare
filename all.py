...
class FilePlugin_V21(ophyd.Device):
    lazy_open = Cpt(SignalWithRBV, 'LazyOpen', string=True, doc="0='No' 1='Yes'")


class FilePlugin_V22(ophyd.Device):
...
class PluginBase_V21(ophyd.Device):
...
class HDF5Plugin_V20(HDF5Plugin, version=(2, 0)):
...
class HDF5Plugin_V22(HDF5Plugin_V21, version=(2, 2)):
...
class HDF5Plugin_V25(HDF5Plugin_V22, version=(2, 5)):
    ...
    swmr_cb_counter = Cpt(EpicsSignalRO, 'SWMRCbCounter_RBV', string=True, doc="0='Off' 1='Active'")
    swmr_mode = Cpt(SignalWithRBV, 'SWMRMode', string=True, doc="0='Off' 1='On'")
    swmr_supported = Cpt(EpicsSignalRO, 'SWMRSupported_RBV', string=True, doc="0='Not Supported' 1='Supported'")
    extra_dim_chunk = DDC_SignalWithRBV(
            ...
            doc="extra_dim_chunk",
            default_read_attrs=['extra_dim_chunk3', 'extra_dim_chunk4', 'extra_dim_chunk5', 'extra_dim_chunk6', 'extra_dim_chunk7', 'extra_dim_chunk8', 'extra_dim_chunk9'],
            )
    extra_dim_chunk = DDC_SignalWithRBV(
    ...
    extra_dim_name = DDC_EpicsSignalRO(
            ...
            doc="extra_dim_name",
            default_read_attrs=['extra_dim_name3', 'extra_dim_name4', 'extra_dim_name5', 'extra_dim_name6', 'extra_dim_name7', 'extra_dim_name8', 'extra_dim_name9'],
            )
    extra_dim_size = DDC_SignalWithRBV(
            ...
            doc="extra_dim_size",
            default_read_attrs=['extra_dim_size3', 'extra_dim_size4', 'extra_dim_size5', 'extra_dim_size6', 'extra_dim_size7', 'extra_dim_size8', 'extra_dim_size9'],
            )
    pos_index_dim = DDC_SignalWithRBV(
            ...
            doc="pos_index_dim",
            default_read_attrs=['pos_index_dim3', 'pos_index_dim4', 'pos_index_dim5', 'pos_index_dim6', 'pos_index_dim7', 'pos_index_dim8', 'pos_index_dim9'],
            )
    pos_index_dim = DDC_SignalWithRBV(
    ...
    pos_name_dim = DDC_SignalWithRBV(
            ...
            doc="pos_name_dim",
            default_read_attrs=['pos_name_dim3', 'pos_name_dim4', 'pos_name_dim5', 'pos_name_dim6', 'pos_name_dim7', 'pos_name_dim8', 'pos_name_dim9'],
            )
    pos_name_dim = DDC_SignalWithRBV(
...
class HDF5Plugin_V32(HDF5Plugin_V25, version=(3, 2)):
    ...
    blosc_level = Cpt(SignalWithRBV, 'BloscLevel', string=True,
            doc="0='blosclz' 1='lz4' 2='lz4hc' 3='snappy' 4='zlib' 5='zstd'")
    ...
    io_speed = Cpt(EpicsSignal, 'IOSpeed', string=True,
            doc="0='None' 1='N-bit' 2='szip' 3='zlib' 4='blosc'")
    run_time = Cpt(EpicsSignal, 'RunTime', string=True,
            doc="0='None' 1='N-bit' 2='szip' 3='zlib' 4='blosc'")
    swmr_active = Cpt(EpicsSignalRO, 'SWMRActive_RBV', string=True, doc="0='Off' 1='Active'")
    swmr_cb_counter = Cpt(EpicsSignalRO, 'SWMRCbCounter_RBV', string=True, doc="0='Off' 1='Active'")
    swmr_supported = Cpt(EpicsSignalRO, 'SWMRSupported_RBV', string=True, doc="0='Not Supported' 1='Supported'")
...
class MagickPlugin_V31(MagickPlugin, FilePlugin_V22, version=(3, 1)):
    bit_depth = Cpt(SignalWithRBV, 'BitDepth', string=True,
            doc="1='1' 8='8' 16='16' 32='32'")


# --- NDFileNetCDF.template ---
class NetCDFPlugin_V21(NetCDFPlugin, PluginBase_V21, FilePlugin_V21, version=(2, 1)):
    ...
...
class ProcessPlugin_V33(ProcessPlugin, version=(3, 3)):
...
class ROIPlugin_V26(ROIPlugin, version=(2, 6)):
...
class ROIStatPlugin_V22(PluginBase_V21, version=(2, 2)):
...
class ROIStatPlugin_V23(ROIStatPlugin_V22, version=(2, 3)):
    ...
    ts_current_point = Cpt(EpicsSignal, 'TSCurrentPoint', string=True,
            doc="0='Erase/Start' 1='Start' 2='Stop' 3='Read'")
    ts_num_points = Cpt(EpicsSignal, 'TSNumPoints', string=True,
            doc="0='Erase/Start' 1='Start' 2='Stop' 3='Read'")
    ts_read = Cpt(EpicsSignal, 'TSRead', string=True,
            doc="0='Erase/Start' 1='Start' 2='Stop' 3='Read'")


# --- NDStats.template ---

class StatsPlugin_V21(StatsPlugin, PluginBase_V21, version=(2, 1)):
    ...

class StatsPlugin_V22(StatsPlugin_V21, version=(2, 2)):
...
class StatsPlugin_V25(StatsPlugin_V22, version=(2, 5)):
    ts_timestamp = Cpt(EpicsSignal, 'TSTimestamp')


class StatsPlugin_V26(StatsPlugin_V25, version=(2, 6)):
...
class StatsPlugin_V32(StatsPlugin_V26, version=(3, 2)):
    histogram_x = Cpt(EpicsSignalRO, 'HistogramX_RBV')


class StatsPlugin_V33(StatsPlugin_V32, version=(3, 3)):
...
class TransformPlugin_V21(TransformPlugin, version=(2, 1)):
    name_ = None  # REMOVED
    origin_location = None  # REMOVED
    types = Cpt(EpicsSignal, 'Type', string=True,
...
class PvaPlugin_V25(PluginBase_V21, version=(2, 5)):
...
class FFTPlugin_V25(PluginBase_V21, version=(2, 5)):
    ...
    fft_freq_axis = Cpt(EpicsSignal, 'FFTFreqAxis', string=True, doc="0='Time to freq.' 1='Freq. to time'")
    fft_imaginary = Cpt(EpicsSignal, 'FFTImaginary', string=True, doc="0='Time to freq.' 1='Freq. to time'")
    fft_num_average = Cpt(SignalWithRBV, 'FFTNumAverage', string=True, doc="0='Time to freq.' 1='Freq. to time'")
    fft_num_averaged = Cpt(EpicsSignal, 'FFTNumAveraged', string=True, doc="0='Time to freq.' 1='Freq. to time'")
    fft_real = Cpt(EpicsSignal, 'FFTReal', string=True, doc="0='Time to freq.' 1='Freq. to time'")
    ...
    fft_time_axis = Cpt(EpicsSignal, 'FFTTimeAxis', string=True, doc="0='Disable' 1='Enable'")
    fft_time_per_point = Cpt(SignalWithRBV, 'FFTTimePerPoint', string=True, doc="0='Disable' 1='Enable'")
    fft_time_per_point_link = Cpt(EpicsSignal, 'FFTTimePerPointLink', string=True, doc="0='Disable' 1='Enable'")
    fft_time_series = Cpt(EpicsSignal, 'FFTTimeSeries', string=True, doc="0='Disable' 1='Enable'")
...
class ScatterPlugin_V31(PluginBase_V21, version=(3, 1)):
...
class PosPluginPlugin_V25(PluginBase_V21, version=(2, 5)):
    ...
    id_difference = Cpt(SignalWithRBV, 'IDDifference', string=True, doc="0='No' 1='Yes'")
...
class CircularBuffPlugin_V22(PluginBase_V21, version=(2, 2)):
...
class CircularBuffPlugin_V34(CircularBuffPlugin_V22, version=(3, 4)):
    flush_on_soft_trg = Cpt(SignalWithRBV, 'FlushOnSoftTrg', string=True, doc="0='OnNewImage' 1='Immediately'")


# --- NDAttributeN.template ---


class AttributeNPlugin_V22(PluginBase_V21, version=(2, 2)):
...
class AttrPlotPlugin_V31(PluginBase_V21, version=(3, 1)):
...
class TimeSeriesNPlugin_V25(PluginBase_V21, version=(2, 5)):
    name_ = Cpt(EpicsSignal, 'Name', string=True)
...
class TimeSeriesPlugin_V25(PluginBase_V21, version=(2, 5)):
    ts_acquire = Cpt(EpicsSignal, 'TSAcquire')
    ts_acquire_mode = Cpt(SignalWithRBV, 'TSAcquireMode', string=True,
            doc="0='Fixed length' 1='Circ. buffer'")
    ts_acquiring = Cpt(EpicsSignal, 'TSAcquiring', string=True, doc="0='Done' 1='Acquiring'")
    ts_averaging_time = Cpt(SignalWithRBV, 'TSAveragingTime', string=True, doc="0='Done' 1='Acquiring'")
    ts_current_point = Cpt(EpicsSignal, 'TSCurrentPoint', string=True, doc="0='Done' 1='Acquiring'")
    ts_elapsed_time = Cpt(EpicsSignal, 'TSElapsedTime', string=True, doc="0='Done' 1='Acquiring'")
    ts_num_average = Cpt(EpicsSignal, 'TSNumAverage', string=True, doc="0='Done' 1='Acquiring'")
    ts_num_points = Cpt(EpicsSignal, 'TSNumPoints', string=True, doc="0='Done' 1='Acquiring'")
    ...
    ts_time_per_point = Cpt(SignalWithRBV, 'TSTimePerPoint', string=True, doc="0='Done' 1='Read'")
    ts_time_per_point_link = Cpt(EpicsSignal, 'TSTimePerPointLink', string=True, doc="0='Done' 1='Read'")
...
class CodecPlugin_V34(PluginBase_V21, version=(3, 4)):
    blosc_cl_evel = Cpt(SignalWithRBV, 'BloscCLevel')
    blosc_compressor = Cpt(SignalWithRBV, 'BloscCompressor', string=True,
            doc="0='BloscLZ' 1='LZ4' 2='LZ4HC' 3='SNAPPY' 4='ZLIB' 5='ZSTD'")
    blosc_num_threads = Cpt(SignalWithRBV, 'BloscNumThreads', string=True,
            doc="0='BloscLZ' 1='LZ4' 2='LZ4HC' 3='SNAPPY' 4='ZLIB' 5='ZSTD'")
    blosc_shuffle = Cpt(SignalWithRBV, 'BloscShuffle', string=True,
            doc="0='None' 1='Bit' 2='Byte'")
    codec_error = Cpt(EpicsSignal, 'CodecError', string=True,
            doc="0='None' 1='Bit' 2='Byte'")
    codec_status = Cpt(EpicsSignal, 'CodecStatus', string=True,
            doc="0='Success' 1='Warning' 2='Error'")
    comp_factor = Cpt(EpicsSignalRO, 'CompFactor_RBV', string=True,
            doc="0='Success' 1='Warning' 2='Error'")
    compressor = Cpt(SignalWithRBV, 'Compressor', string=True,
            doc="0='None' 1='JPEG' 2='Blosc'")
    jpeg_quality = Cpt(SignalWithRBV, 'JPEGQuality', string=True,
            doc="0='None' 1='JPEG' 2='Blosc'")
