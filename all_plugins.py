...
class HDF5Plugin_V25(HDF5Plugin_V22, version=(2, 5), version_of=HDF5Plugin):
    ...
    extra_dim_chunk_TODO = DDC_SignalWithRBV(
        ("extra_dim_chunk_x", "ExtraDimChunkX"),
        ("extra_dim_chunk_y", "ExtraDimChunkY"),
        doc="extra_dim_chunk",
    )
    # Overriding extra_dim_name=OrderedDict([('name_x', (<class 'ophyd.signal.EpicsSignalRO'>, 'ExtraDimNameX_RBV', {'lazy': True})), ('name_y', (<class 'ophyd.signal.EpicsSignalRO'>, 'ExtraDimNameY_RBV', {'lazy': True})), ('name_n', (<class 'ophyd.signal.EpicsSignalRO'>, 'ExtraDimNameN_RBV', {'lazy': True}))])
    ...
    pos_index_dim_TODO = DDC_SignalWithRBV(
    ...
    pos_name_dim_TODO = DDC_SignalWithRBV(
